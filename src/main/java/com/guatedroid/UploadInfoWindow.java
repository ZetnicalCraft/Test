...
public class UploadInfoWindow extends Window implements
    ...
    private AgregarControlador controlador;
    ...
    public void uploadSucceeded(final Upload.SucceededEvent event) {
        ...
        String todoElTexto = counter.getTodoElTexto();
        System.out.println("Iniciando subida a base de datos.");
        controlador = new AgregarControlador(todoElTexto);
